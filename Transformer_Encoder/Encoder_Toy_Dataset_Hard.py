...
# Load dataset Hard
hard_data_path = '../Dataset/Harder_task_toy_data_binary.pkl'

# processed_data_dict = joblib.load(hard_data_path)
processed_data_dict = joblib.load(hard_data_path)
...
for learning_rate in [0.1, 0.01 , 0.001 , 0.0001]:
    ...
    for pe_scaling_factor in [0 , 0.01 , 0.1 , 0.2, 0.5 , 1 , 2, 10]:
        ...
        fig_name = 'dp_0.1_One_Encoder_5_heads_hard_dataset_lr_' + str(learning_rate) + '_constant_pe_scaling_' + str(pe_scaling_factor) 
